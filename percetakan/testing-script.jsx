...
var myText=prompt("masukkan jumlah file yang dicetak dan ket. lain","1 lembar ","PERHATIAN!!!");
  var namePan = win.add('panel', undefined, 'Name settings');
  namePan.alignChildren = 'left';
  // Add size in file name or not
  var chkName = namePan.add('checkbox', undefined, 'Add width and height (cm)'+myText);
  chkName.helpTip = 'Sample: <your-filename>-print.tif or <your-filename>- 210x99cm -print.tif';
  ...
  chkUnit.helpTip = 'If size > 1000 cm convert cm > cm > m';
  ...
  function okClick() {
    ...
    var nameTpl = prepareName(originDoc) + sizeSuffix +'=' +myText; // // Name template
...
function calcSize(doc, value) {
  ...
  // Convert unit only for large layout >=1000x1000 cm
...
function SaveTIFF(fileName, ext, compression) {
  ...
  alert('File Tersimpan dengan nama:\n' + decodeURI(file.name));
}
